const AppInitData = {
    ...
    fav : [
        {name: "workspace1", id:"0"},
        {name: "workspace2", id:"1"},
        {name: "workspace2", id:"6"},
        {name: "workspace2", id:"7"},
    ],
    member : [
        {name: "workspace1", id:"6"},
        {name: "workspace2", id:"7"},
        {name: "workspace2", id:"8"},
        {name: "workspace2", id:"9"},
        {name: "workspace2", id:"10"},
        {name: "workspace2", id:"11"},
    ],
    notifications : [
        {
            title: "Board Noti Test",
            workspaceName: "test1",
            desc: "test Noti",
            type: "board",
            endDate: "2021/06/30",
